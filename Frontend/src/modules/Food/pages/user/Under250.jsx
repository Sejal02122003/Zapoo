...
const MOCK_UNDER250_RESTAURANTS = [
  {
    id: "mock-1",
    name: "Gunjan's Caffe",
    deliveryTime: "30 min",
  ...
  },
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        price: 80,
        isVeg: true,
        image: "https://images.unsplash.com/photo-1563805042-7684c8a9e9ce?q=80&w=800&auto=format&fit=crop"
      }
    ]
  },
  {
  ...
  {
    id: "mock-4",
    name: "Renu's Restaurant",
    deliveryTime: "20-30 min",
    distance: "4.2 km",
    rating: 0,
    isNew: true,
    slug: "renus-restaurant",
    menuItems: [
      {
        id: "mock-item-6",
        name: "special Thali",
...
export default function Under250() {
  ...
  const handleCategorySwitch = useCallback((categoryId) => {
    if (Object.keys(COLLECTION_DATA).includes(categoryId)) {
      navigate(`/user/collection/${categoryId}`)
      return
    }
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5 cursor-pointer">
              <span className="text-xs md:text-sm font-black text-white tracking-wider drop-shadow-sm">UNDER ₹250</span>
          ...
          <div className="relative z-0 w-full flex flex-col items-center justify-center px-4 md:px-6 text-white text-center min-h-[220px] md:min-h-[280px]">
            ...
            >
              ...
              <p className="text-xs sm:text-sm md:text-base lg:text-lg font-medium text-white/95 max-w-xs sm:max-w-sm md:max-w-md drop-shadow-md mt-4 sm:mt-6 leading-relaxed">
                Delicious meals that won't break the bank. Explore the best budget bites in your area!
              </p>
