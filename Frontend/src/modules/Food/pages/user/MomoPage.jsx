...
const MOCK_MOMO_RESTAURANTS = [
    ...
    menuItems: [
      {
        ...
        price: 120,
        isVeg: true,
        image: "https://images.unsplash.com/photo-1625220194771-7eb5a2225215?q=80&w=800&auto=format&fit=crop"
      },
      {
        id: "momo-item-2",
  ...
  {
    id: "momo-3",
    name: "Tandoori Momo Junction",
    deliveryTime: "30-40 min",
    distance: "5.1 km",
    rating: 4.2,
    totalRatings: 850,
    isNew: false,
    slug: "tandoori-momo-junction",
    menuItems: [
      {
        id: "momo-item-5",
        name: "Tandoori Soya Momo",
        price: 200,
        isVeg: true,
      ...
      {
        id: "momo-item-6",
        name: "Afghani Malai Momo",
        price: 220,
        isVeg: true,
        image: "https://images.unsplash.com/photo-1627515869408-db3f741da809?q=80&w=800&auto=format&fit=crop"
      }
    ]
  }
];
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5 cursor-pointer">
              <span className="text-xs md:text-sm font-black text-white tracking-wider drop-shadow-sm">MOMO CRAVINGS</span>
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black italic tracking-tighter drop-shadow-lg mb-2 sm:mb-3 flex items-center justify-center flex-wrap gap-2 sm:gap-4 w-full">
                ...
                <span className="relative inline-block mt-2 sm:mt-0">
                  <span className="relative z-10">MOMOS?</span>
                  <motion.div 
          ...
          (() => {
            ...
            if (allMomoItems.length === 0) {
              return (
                <div className="flex justify-center items-center py-12">
                  <div className="text-gray-500 dark:text-gray-400">
                    No momo varieties match the selected filters.
                  </div>
                </div>
              );
            }
