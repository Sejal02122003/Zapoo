...
// Mock data is now imported from collectionData.js
...
export default function CollectionPage() {
  ...
  const collection = COLLECTION_DATA[category]
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5 cursor-pointer">
              <span className="text-xs md:text-sm font-black text-white tracking-wider drop-shadow-sm">{collection.dropdownTitle}</span>
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black italic tracking-tighter drop-shadow-lg mb-2 sm:mb-3 flex items-center justify-center flex-wrap gap-2 sm:gap-4 w-full">
                ...
                <span className="relative inline-block mt-2 sm:mt-0">
                  <span className="relative z-10">{collection.titleMain}?</span>
                  <motion.div 
