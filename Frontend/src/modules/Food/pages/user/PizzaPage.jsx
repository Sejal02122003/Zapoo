    ...
    menuItems: [
      {
        ...
        price: 349,
        isVeg: false,
        image: "https://images.unsplash.com/photo-1566810141673-a447814619cd?q=80&w=800&auto=format&fit=crop"
      },
      {
        id: "pizza-item-6",
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5 cursor-pointer">
              <span className="text-xs md:text-sm font-black text-white tracking-wider drop-shadow-sm">PIZZA PARTY</span>
          ...
          <div className="relative z-0 w-full flex flex-col items-center justify-center px-4 md:px-6 text-white text-center min-h-[220px] md:min-h-[280px]">
            ...
            >
              ...
              <p className="text-xs sm:text-sm md:text-base lg:text-lg font-medium text-white/95 max-w-xs sm:max-w-sm md:max-w-md drop-shadow-md mt-4 sm:mt-6 leading-relaxed">
                From classic margherita to loaded supreme, get your perfect slice delivered hot!
              </p>
