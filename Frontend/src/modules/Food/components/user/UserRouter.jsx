    ...
    <Suspense fallback={<Loader />}>
      <Routes>
        <Route element={<UserLayout />}>
          ...
          <Route path="under99" element={<Navigate to="/food/under-99" replace />} />
          <Route path="user/under99" element={<Navigate to="/food/under-99" replace />} />
          <Route path="user/under-99" element={<Navigate to="/food/under-99" replace />} />
