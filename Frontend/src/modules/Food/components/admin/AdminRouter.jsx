...
const WeatherPricing = lazy(() => import("@food/pages/admin/fee-settings/WeatherPricing"));
...
const SurgePricing = lazy(() => import("@food/pages/admin/restaurant/SurgePricing"));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="food/*">
            ...
            <Route path="restaurants/surge-pricing" element={<SurgePricing />} />
            ...
            <Route path="weather-pricing" element={<WeatherPricing />} />
