...
export default function ReassignDeliveryModal({ orderId, isOpen, onClose, onAssigned }) {
  ...
  const handleAssign = async (partnerId) => {
    try {
      ...
      const res = await adminAPI.reassignDeliveryPartner(orderId, partnerId, incentiveReason);
      if (res?.data?.success) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-xl flex flex-col max-h-[85vh]">
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
          <div className="mb-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
            <h3 className="text-sm font-semibold text-gray-800 mb-3">Optional: Reassignment Reason</h3>
            <div className="grid grid-cols-1 gap-4">
              <div>
                <input 
                  ...
                  placeholder="e.g. Rider vehicle broke down"
